...
public abstract class AbstractTileInfo {
     ...
     */
    private Vector2[] mapCenterInPixelsAtZoom;// = new Point2D.Double[18];
	 ...
	 */
    public AbstractTileInfo(int minimumZoomLevel, int maximumZoomLevel, int totalMapZoom, int tileSize, boolean xr2l,
	 ...
	 * based on the equator.
	 */
    public AbstractTileInfo(String name, int minimumZoomLevel, int maximumZoomLevel, int totalMapZoom, int tileSize,
                            boolean xr2l, boolean yt2b, String baseURL, String xparam, String yparam, String zparam)
    {
        ...
        mapCenterInPixelsAtZoom = new Vector2[totalMapZoom + 1];
     ...
     */
    public Vector2 getMapCenterInPixelsAtZoom(int zoom)
    {
